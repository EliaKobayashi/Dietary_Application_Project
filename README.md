...
| 3        | Brainstorm and write the design statement                | A clear  problem design statement that suits the need of the client | 20 mins        | March 2                | A        | Planning     |
...
| 6        | Write the proposed solution of the application           | A clear solution that meets the needs of the client                 | 20 mins        | March 2                | A        | Planning     |
| 7        | Draw and describe the ER diagram                         | Draw an ER diagram that illustrates the tables and attributes of the solution with a brief explanation | 20 mins        | March 4                | B        | Design       |
| 8        | Draw and describe the table of data                      | Draw a tables of data for the two tables with attributes and values along with a brief explanation | 15 mins        | March 4                | B        | Design       |
| 9        | Draw and describe the UML diagram                        | Draw a UML diagram that illustrates the classes, objects, and methods of the solution along with a brief explanation | 15 mins        | March 4                | B        | Design       |
| 10       | Code the log in screen                                   | A working log in screen with Python and KivyMD with a GUI | 1 hour         | March 7                | C        | Development  |
| 11       | Code the register screen                                 | A working register screen with Python and KivyMD with a GUI | 1 hour         | March 9                | C        | Development  |
| 12       | Meeting with client                                      | Get client's opinion on the progress | 5 minutes      | March 10               | A        | Evaluation   |
| 13       | Code switches between screens                            | Working buttons that changes screens using Python and KivyMD with a GUI | 30 mins        | March 10               | C        | Development  |
| 14       | Code tables of the user inputs on the databse | Tables that appear on the SQLite databse | 50 mins        | March 10               | C        | Development  |
| 15       | Code the encryption of passwords using hash              | Registered passwords should be encyrpted on the database | 40 mins        | March 28               | C        | Development  |
| 16       | Meeting with client                                      | Get client's opinion on the progress | 5 minutes      | March 28               | A        | Evaluation   |
| 17       | Fix up the register screen                               | Ensure that the register screen works and that it looks neat | 15 mins        | March 30               | C        | Development  |
| 18       | Fix up the hash password encryption                      | Ensure that the password consistenly encryption using hash | 15 mins        | March 30               | C        | Development  |
| 18       | Draw and describe the flow diagrams                      | Draw flow diagrams for different parts of the solution along with a brief explanation | 20 mins        | March 31               | B        | Design       |
| 19       | Create the Input screen                                  | Create a screen that allows the client to input nutrient values | 30 minutes     | April 2                | C        | Development  |
| 20       | Create the nutrient table                                | Create the nutrient table that shows up on the databse | 30 minutes     | April 2                | C        | Development  |
| 21       | Create the Table screen                                  | Create a screen that shows the table in the database | 1 hour 30 minutes     | April 8                | C        | Development  |
| 22       | Create a calendar for the date                           | Create a calendar that users can click on to input the date of when they are inpputing nutrient values | 25 mins        | April 11               | C        | Development  |
...
| 24       | Write the test plans                                     | Write procedures one should undergo to test the program and the expected outcome on Github | 30 mins        | April 13               | C        | Development  |
| 25       | Meeting with client for final product                    | Get client approval on the final product | 15 mins        | April 13               | A        | Evaluation   |
| 26       | Finish Criteria C                                        | Write the descriptions of the code and detail the techniques that were used on Github |2 hours        | April 14               | C        | Development  |
