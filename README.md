...
4. After the user logs in, the user should be able to pick whether they want to log their nutrients intake (protein, fat, carbohydrates and calories) or monitor their PFC intakes.
